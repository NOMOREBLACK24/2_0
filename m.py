...
bot = telebot.TeleBot('8186668073:AAExFu6xyq8VgPLF1WpyBIN04oWbs3arhm0')

# Admin user IDs
admin_id = ["7663163950", "6114033856"]
...
def clear_logs_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from :- @FLAME1969 ❄."
    bot.reply_to(message, response)
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @FLAME1969 🙇."
    bot.reply_to(message, response)
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP- User of @FLAME1969 , @NOMORE231"
    bot.reply_to(message, response)
...
Buy From :- @FLAME1969 , @NOMORE231
Official Channel :- https://t.me/+Es1xtKuzncA5MjZl
'''
...
3. MAKE SURE YOU JOINED https://t.me/+Es1xtKuzncA5MjZl OTHERWISE NOT WORK
